...
rozgrywka_odpowiedzi = [
                    ...
                    ["A. W", "B. S", "C. N", "D. E (p)"],
                    ["A. 32 procent (p)", "B. 19 procent ", "C. 24 procent", "D. 43 procent"],
                    ["A.Oman", "B.Syria (p)", "C.Jemen", "D.Arabia Saudyjska"],
                    ["A.Jest tylko legendą", "B.Powstała w XI w. n.e.", "C.Każda figurka jest inna (p)", "D. Powstała w Japonii"],
                    ["A.Wenus", "B.Merkurego", "C.Jowisza", "D.Marsa (p)"],
                    ["A.Jakub Szela (p)", "B.Janosik", "C. Jan Kiliński", "D.Tadeusz Kościuszko"],
